      ...
      <SimpleSection className="bg-[#f8fbff]">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div>
            ...
            <p className="mt-6 max-w-2xl font-body text-lg leading-relaxed text-[#526b86]">Malik East approaches each conversation by listening first. The goal is to make sure you understand the options, costs, trade-offs, and the role a product may — or may not — play in your plan.</p>
