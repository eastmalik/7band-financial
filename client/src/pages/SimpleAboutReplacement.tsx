...
export default function SimpleAboutReplacement() {
  ...
  return (
    <div className="view-mode-enter min-h-screen overflow-x-hidden bg-[#f8fbff] font-body text-[#132945]">
      ...
      <ViewModeToggle />
      <section className="relative overflow-hidden bg-[#edf5ff] px-5 pb-16 pt-36 sm:px-7 sm:pt-44"><SevenPointMark className="absolute right-[13%] top-28 h-24 w-24 text-[#b8892e]/40 sm:h-32 sm:w-32" /><div className="relative mx-auto max-w-7xl"><div className="mb-5 inline-flex items-center gap-2 text-xs font-bold uppercase tracking-[0.16em] text-[#2563eb]"><span className="h-px w-7 bg-[#b8892e]" /> About 7Band Financial Agency</div><h1 className="max-w-4xl font-display text-4xl font-black leading-[1.05] text-[#0b1f3a] sm:text-6xl">From the band room to <span className="text-[#2563eb]">financial harmony.</span></h1></div></section>
      <section className="bg-white px-5 py-20 sm:px-7 lg:py-28"><div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[0.78fr_1.22fr] lg:items-start"><div className="border border-[#dbe7f5] p-2 shadow-[0_14px_34px_rgba(11,31,58,0.07)]"><img src={portraitUrl} alt="Malik East, founder of 7Band Financial Agency" className="aspect-[4/5] w-full object-cover" style={{ objectPosition: "center 26%" }} /><div className="p-5"><p className="font-display text-xl font-bold text-[#0b1f3a]">Malik East</p><p className="mt-1 font-tactical text-xs font-bold uppercase tracking-[0.12em] text-[#2563eb]">TheFlow · Founder · Licensed Life Insurance Agent</p></div></div><div><div className="mb-5 inline-flex items-center gap-2 text-xs font-bold uppercase tracking-[0.16em] text-[#2563eb]"><span className="h-px w-7 bg-[#b8892e]" /> Meet Malik</div><h2 className="font-display text-3xl font-black leading-tight text-[#0b1f3a] sm:text-5xl">A guide who makes the moving pieces make sense.</h2><div className="mt-7 space-y-5 font-body text-lg leading-relaxed text-[#526b86]"><p>Malik East, known as TheFlow, is the founder of 7Band Financial Agency and a licensed life insurance agent since 2020. He earned a B.S. in Computer Networking and Information Technology from Alcorn State University in 2019, bringing a systems-minded perspective to financial education.</p><p>His story began in a 7th-grade band room in 2007. Learning saxophone taught him that great music needs timing, rhythm, and harmony — the same principles he now uses to explain how financial decisions can work together rather than compete with one another.</p><p>That idea became 7Band. Alongside his wife, Mickala, who manages client screenings, Malik helps people prepare for conversations about credit, protection, and long-term planning. His standard is simple: understand the whole picture before you decide whether a policy or strategy belongs in it.</p></div><blockquote className="mt-8 border-l-2 border-[#b8892e] pl-6 py-1 font-display text-xl font-bold leading-snug text-[#0b1f3a]">“Every time a client reaches a financial goal, it’s music to my ears.”</blockquote><a href={calendlyUrl} target="_blank" rel="noopener noreferrer" className="mt-8 inline-flex items-center gap-2 bg-[#0b1f3a] px-6 py-4 font-tactical text-sm font-bold uppercase tracking-[0.12em] text-white hover:bg-[#2563eb]">Schedule a conversation <ArrowRight size={16} /></a></div></div></section>
