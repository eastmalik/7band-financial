        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              { icon: <Music size={22} className="text-[#c9a84c]" />, title: "The 7Band Philosophy", body: "The 7-Level Blueprint requires every financial tool to be deployed in the right sequence." },
